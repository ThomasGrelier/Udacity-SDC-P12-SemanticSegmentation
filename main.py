...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer = tf.layers.conv2d_transpose(vgg_layer7_out, layer4_tensor_shape[3], 4, strides=(2, 2),\
                padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    layer = tf.add(layer, vgg_layer4_out)
    layer = tf.layers.conv2d_transpose(layer, layer3_tensor_shape[3], 4, strides=(2, 2))
